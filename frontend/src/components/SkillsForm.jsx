  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type="text" placeholder='Enter a skill (e.g.,Java,C,C++,Python)' className='flex-1 px-3 py-3 text-sm' onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress} />
      ...
      <div className='bg-blue-100 p-3 rounded-lg'>
        <p className='text-sm text-blue-800'> <strong>Tip:</strong> Add 8-12 relevant skills. Include both tech and soft skills...</p>
      </div>
    </div>
  )
}
